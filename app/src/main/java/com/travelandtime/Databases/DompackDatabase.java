...
public class DompackDatabase extends SQLiteOpenHelper {
    private Context context;
    public DompackDatabase(Context context) {
        super(context,"My_DomPack",null,1);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Dompack (id INTEGER PRIMARY KEY AUTOINCREMENT,sr TEXT,title TEXT,desc1 TEXT,img TEXT,location TEXT,price TEXT,nop TEXT,cat TEXT,day TEXT,night TEXT)");
    }
    ...
    public void insert(String sr, String title, String desc1, String img, String location, String price, String nop, String cat, String day, String night) {
        ...
        sqLiteDatabase.insert("Dompack",null,contentValues);
    ...
    public ArrayList<HashMap<String,String>> getDatabaseName(String sr) {
        ...
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        Cursor cursor=sqLiteDatabase.rawQuery("SELECT * FROM Dompack WHERE sr="+sr,null);
    ...
    public ArrayList<HashMap<String,String>> getDatabaseName(String imei,String email) {
        ...
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        Cursor cursor1=sqLiteDatabase.rawQuery("SELECT * FROM Dompack",null);
