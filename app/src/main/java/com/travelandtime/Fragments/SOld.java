...
class SOld extends RecyclerView.Adapter<SOld.Holder> {
    private ArrayList<SList2> sList2;
    private Context mcontext;
    DownloadManager dm;
    long queueid;
    SOld(Context mcontext, ArrayList<SList2> sList2) {
        this.sList2=sList2;
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int i) {
        String image_url=sList2.get(i).getImage_url();
        Picasso.get().load(image_url).into(holder.F2img);
        holder.F2currentDate.setText(sList2.get(i).getReg_date());
        holder.F2HotelName.setText(sList2.get(i).getHotel_name());
        holder.F2RoomName.setText(sList2.get(i).getRoom_name());
        holder.F2checkIn.setText("Check-In "+sList2.get(i).getCheck_in());
        holder.F2statusTxt.setText(sList2.get(i).getCurrent_status());
        holder.F1statusTxt2.setText(sList2.get(i).getCurrent_status());
        holder.F2download.setText("Download");
        holder.F2view.setText("View");
        holder.F3show.setText("Show");
        if(sList2.get(i).getCurrent_status().equals("New Offer"))
        {
        ...
        holder.F2download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DownloadManager.Request request=new DownloadManager.Request(Uri.parse(sList2.get(i).getFile_url()));
        ...
        holder.F3show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("url",sList2.get(i).getFile_url());
                mcontext.startActivity(intent);
            }
        });
